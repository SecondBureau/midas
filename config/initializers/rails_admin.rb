# RailsAdmin config file. Generated on May 14, 2012 10:53
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Midas', 'Admin']
  ...
  # config.excluded_models = [Account, Bank, Category, Entry, Invoice, InvoiceStatus, PaymentMode, ToAccountant, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Account, Bank, Category, Entry, Invoice, InvoiceStatus, PaymentMode, ToAccountant, User]
  ...
  #     configure :currency, :string 
  #     configure :src_amount_in_cents, :integer 
  #     configure :amount_in_cents, :integer 
  #     configure :status, :string 
  #     configure :invoice_num, :string 
